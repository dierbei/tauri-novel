      ...
      <div className="max-w-2xl mx-auto px-4 py-8 pb-32">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
          {menuItems.map((item, index) => (
            <button
              key={index}
              className="w-full flex items-center gap-4 p-4 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors border-b border-gray-100 dark:border-gray-700 last:border-0"
            >
